 ...
 * @Date: 2026-05-10 20:32:06
 * @LastEditors: Adrian 1529366751@qq.com
 * @LastEditTime: 2026-05-10 20:40:05
 * @FilePath: /agent_learning/runnable-test/src/runnables/RunnableWithMessageHistory.mjs
...
const result1 = await chain.invoke(
  {
    question: "我的名字是柏林，我来自黑龙江，我喜欢编程、三角洲、金铲铲。",
  },
  {
    configurable: {
      sessionId: "user-123",
...
console.log("问题: 我的名字是柏林，我来自黑龙江，我喜欢编程、三角洲、金铲铲。");
